...
wp_enqueue_style('highlight', get_template_directory_uri() . '/css/tomorrow-night-eighties.css', array(), '1.0.0', 'all');
...
function highlight_shortcode( $atts, $content = '') {    //引数として$classと$contentを定義
return '<pre><code class =　'.$atts['name'].'>'.$content.'</code></pre>';    //引数で渡された$classと$contentが代入される
}
